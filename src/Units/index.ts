...
export const liter = deci.meter(1).cubed().named<Q.Volume>('l');
export const tonne = kilogram(1000).named<Q.Mass>('t');
export const dalton = yocto.gram(1.6605390666).named<Q.Mass>('Da');
export const electronvolt = zepto.joule(160.2176634).named<Q.Energy>('eV');
export const gal = centi.meter(1).per(second(1).squared()).named<Q.Acceleration>('Gal');
